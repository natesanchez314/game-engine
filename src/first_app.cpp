...
namespace nate {
	...
	void FirstApp::loadGameObjects() {
		...
		std::shared_ptr<Model> nateModel0 = Model::createModelFromFile(nateDevice, "res/smooth_vase.obj");
		std::shared_ptr<Model> nateModel1 = Model::createModelFromFile(nateDevice, "res/flat_vase.obj");
        std::shared_ptr<Model> quad = Model::createModelFromFile(nateDevice, "res/quad.obj");

        auto gameObject0 = GameObject::createGameObject();
