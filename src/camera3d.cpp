...
namespace nate {
	...
	void Camera3d::setViewDir(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	void Camera3d::setOrthoProj(float left, float right, float top, float bottom, float near, float far) {
	...
	void Camera3d::setPersProj(float fovy, float aspect, float near, float far) {
